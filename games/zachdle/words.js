/* ============================================================
   ...
   game will pick from when choosing a secret.

   ZD_ALLOWED: a larger superset used for guess validation. Wraps
   ZD_ANSWERS plus extras so most well-known 5-letter words are
   accepted as guesses even when they'd be too rare to use as the
   secret.

   To swap in the official Wordle lists, replace these two arrays
   in this file — game code only reads window.ZD_ANSWERS and
   window.ZD_ALLOWED.
   ============================================================ */
...
window.ZD_ANSWERS = [
  ...
  "cairn","camel","cameo","canal","candy","canny","canoe","canon","caper","capon",
  ...
  "curly","curry","curse","curve","curvy","cushy","cynic","cyber",
  // D
  "daddy","daily","dairy","daisy","dally","dance","dandy","datum","daunt","dealt",
  "death","debar","debit","debug","debut","decal","decay","decor","decoy","decry",
  "deeds","deeper","defer","deify","deign","deity","delay","delta","delve","demon",
  "demur","denim","dense","depot","depth","derby","detox","deuce","devil","diary",
  "dicey","digit","dilly","dimly","diner","dingo","dingy","diode","dirge","dirty",
  "disco","ditch","ditto","ditty","diver","dizzy","dodge","dodgy","doing","dolly",
  ...
  "droop","dross","drove","drown","druid","drunk","dryer","dryly","duchy","duddy",
  "duely","dully","dummy","dumpy","dunce","dusky","dusty","dutch","duvet","dwarf",
  "dwell","dwelt","dying",
  // E
  ...
  "exult","eying",
  // F
  "fable","facet","faint","fairy","faith","false","fancy","fanny","farce","faster",
  ...
  "fluke","flume","flung","flunk","flush","flute","flyby","foamy","focal","focus",
  ...
  // G
  "gable","gaffe","gaily","gamer","gamma","gamut","gassy","gaudy","gauge","gaunt",
  ...
  "pulse","pumice","punch","pungent","pupal","puppy","puree","purer","purge","purse",
  "pushy","putty","pygmy",
  // Q
  ...
  "rumor","rupee","rural","rusty",
  // S
  "sable","sadly","safer","saint","salad","sally","salon","salsa","salty","salve",
  ...
  "scrum","scuba","sedan","seedy","segue","seize","semis","sense","sepia","septa",
  ...
  "tipsy","titan","tithe","title","toady","toast","today","toddy","token","tonal",
  ...
  "truth","tryst","tubal","tuber","tulip","tulle","tumor","tunic","turbo","tutor",
  "twang","tweak","tweed","tweet","twice","twine","twirl","twist","twixt","tying",
  // U
  "udder","ulcer","ultra","umbra","unarm","unbar","uncle","uncut","under","undid",
  ...
  "wiser","wispy","witch","witty","woken","woman","women","wooer","wooly","woozy",
  "wordy","world","worry","worse","worst","worth","would","wound","woven","wrack",
  "wrath","wreak","wreck","wrest","wring","wrist","write","wrong","wrote","wrung",
  "wryly",
  // X-Y-Z
  "xenon","xylem","yacht","yearn","yeast","yield","young","youth","yucca","yummy",
  "zebra","zesty","zilch","zippy","zonal",
];

// Drop anything that isn't exactly 5 lowercase letters — defensive.
window.ZD_ANSWERS = window.ZD_ANSWERS.filter((w) => /^[a-z]{5}$/.test(w));

// Allowed-guess pool: answers plus a wider net of common but more
// obscure 5-letter words. Anything in here is accepted as a guess even
// if it would never be a daily secret.
const ZD_EXTRA_GUESSES = [
  "abaci","abaft","abase","abash","abash","abbas","abbes","abbot","abide","abled",
  "abler","abuts","abuzz","ached","aches","achoo","acidic","acids","acids","acing",
  "acmes","acned","acnes","acorn","acres","acrid","acted","actin","acton","actor",
  "acuta","adage","added","adder","addle","adieu","adios","adits","admin","admit",
  "adobe","adobo","adore","adorn","adult","adust","afars","afire","afore","afoul",
  "after","agars","agate","agave","agers","ageys","aggie","aging","agita","aglow",
  "agony","agora","agree","ahead","aided","aider","aides","aiery","ailed","aimed",
  "aimer","airer","aisle","aitch","ajiva","aknee","alarm","alate","albas","album",
  "alder","aldol","aleph","alert","algae","algal","algas","algid","algin","algor",
  "alias","alibi","alien","align","alike","aline","alive","alkyd","alkyl","allay",
  "alley","allot","allow","alloy","aloed","aloes","aloft","aloha","alone","along",
  "aloof","aloud","alpha","altar","alter","alums","alway","amain","amass","amaze",
  "amber","ambit","amble","ameba","amend","amens","amide","amido","amids","amies",
  "amine","amino","amins","amirs","amiss","amity","ammos","amnia","amnic","among",
  "amour","amped","ample","amply","amuck","amuse","amyls","anal","anchor","angle",
  "anile","anils","anima","anime","anion","annex","annoy","annul","anode","anole",
  "anomy","ansae","antas","anted","antes","antic","antra","antre","antsy","anvil",
  "aorta","apace","apart","apers","apery","aphid","aphis","apish","apium","apnea",
  "apode","aport","apple","apply","apron","apses","apsis","apter","aptly","aqua",
  "aquae","aquas","arbor","arced","arcus","areas","arena","arene","arepa","argal",
  "argol","argon","argot","argue","argus","arias","aride","arils","arise","arles",
  "armed","armer","armet","armor","aroma","arose","array","arrow","arsis","arson",
  "artel","artsy","aruba","arums","ascot","ashed","ashen","ashes","aside","asked",
  "asker","askew","aspen","aspic","aspis","assai","assay","asses","asset","atilt",
  "atlas","atman","atoll","atoms","atomy","atone","atria","atrip","attar","attic",
  "audio","audit","auger","aught","augur","aunts","aunty","aurae","aural","auras",
  "aurum","autos","avail","avant","avast","avens","avers","avert","avian","avoid",
  "avows","await","awake","award","aware","awash","awful","awing","awoke","awols",
  "axels","axial","axile","axing","axiom","axion","axite","axled","axles","axman",
  "axmen","axons","ayahs","azans","azide","azido","azine","azole","azons","azote",
  "azoth","azuki","azure","babas","babel","babes","baboo","babul","babus","bacca",
  "backs","bacon","baddy","badge","badly","baels","baffs","baffy","bagel","baggy",
  "bahts","bails","bairn","baits","baiza","baize","baked","baker","bakes","balas",
  "balds","baldy","baled","baler","bales","balks","balky","balls","bally","balms",
  "balmy","balsa","banal","banco","banda","bandh","bands","bandy","baned","banes",
  "bangs","banjo","banks","banty","baris","barbs","bards","bared","barer","bares",
  "barfs","barge","baric","barks","barky","barms","barmy","barns","barny","baron",
  "barre","bases","basic","basil","basin","basis","basks","baste","basts","batch",
  "bated","bates","bathe","baths","batik","baton","batts","batty","baulk","bawds",
  "bawdy","bawls","bayed","bayou","bazar","beach","beads","beady","beaks","beaky",
  "beams","beamy","beano","beans","beard","bears","beast","beats","beaus","beaux",
  "bebop","becks","bedew","bedim","beech","beefs","beefy","beeps","beers","beery",
  "beets","befit","befog","began","begat","beget","begin","begot","begum","begun",
  "beige","beigy","being","belay","belch","belie","belle","bells","belly","below",
  "belts","bench","bends","bendy","bents","beret","bergs","berms","berry","berth",
  "beryl","beset","besom","besot","bests","betas","betel","beths","bevel","bevy",
  "bezel","bhang","bhuts","bialy","bibbs","bible","bicep","biddy","bided","bider",
  "bides","bidet","biers","biffs","biggy","bigot","bigwig","bijou","biked","biker",
  "bikes","biles","bilge","bilgy","bills","billy","bimah","bimbo","binal","bindi",
  "binds","biner","binge","bingo","bints","biome","biont","biota","biped","bipod",
  "birch","birds","birle","biros","birth","bison","bitch","biter","bites","bitsy",
  "bitty","blabs","black","blade","blahs","blame","blams","bland","blank","blare",
  "blase","blast","blats","blaze","bleak","blear","bleat","blebs","bleed","bleep",
  "blend","bless","blest","blets","blimp","blind","bling","blini","blink","blips",
  "bliss","blitz","bloat","blobs","block","blocs","blocs","blogs","bloke","blond",
  "blood","bloom","bloop","blots","blown","blows","blowy","blubs","blued","bluer",
  "blues","bluet","bluey","bluff","blume","blunt","blurb","blurs","blurt","blush",
  "boars","board","boars","boast","boats","bobby","bocce","bocci","boche","bocks",
  "boded","boder","bodes","boers","boffs","boffo","bogey","boggy","bogie","bogle",
  "bogus","bohea","boils","bolas","bolar","boldy","boles","bolls","bolos","bolts",
  "bolus","bombe","bombs","bonds","boned","boner","bones","boney","bongs","bongo",
  "bonus","booby","booed","books","booms","boomy","boons","boors","boost","boots",
  "booty","booze","boozy","boppy","boral","borax","bored","borer","bores","boric",
  "boris","borne","boron","boson","bossy","botas","botch","botel","bough","boule",
  "bound","bourg","bourn","bouts","bowed","bowel","bower","bowls","boxed","boxer",
  "boxes","boyar","boyla","boyos","bozos","brace","brach","brads","brads","braes",
  "braid","brail","brain","brake","braky","brand","brank","brans","brant","brash",
  "brass","brats","brava","brave","bravi","bravo","brawl","brawn","brays","braze",
  "bread","break","bream","breed","brens","breve","brews","briar","bribe","brick",
  "bride","brief","brier","bries","brigs","brill","brims","brine","bring","brink",
  "briny","brios","brisk","britt","broad","brock","broil","broke","brood","brook",
  "brool","broom","broth","brown","brows","brule","brume","brunt","brush","brusk",
  "brute","bubba","buboe","bucko","bucks","buddy","buffy","buggy","bugle","build",
  "built","bulbs","bulgy","bulks","bulky","bulla","bulls","bully","bumph","bumps",
  "bumpy","bunch","bundt","bungs","bunko","bunks","bunny","bunya","buoys","burbs",
  "burds","burgs","burin","burka","burls","burly","burns","burps","burrs","burry",
  "bursa","burse","burst","busby","bused","buses","busks","busts","busty","butch",
  "buteo","butes","butle","butte","butts","butty","butut","buyer","buzzy","bwana",
  "byres","byrls","bytes","byway",
  // Padded with more common 5-letter words for validation coverage.
  // (Real Wordle's allowed list is ~12k words. This stops well short of
  // that — extend manually or drop in the official list when desired.)
];

window.ZD_ALLOWED = new Set(
  [...window.ZD_ANSWERS, ...ZD_EXTRA_GUESSES].filter((w) => /^[a-z]{5}$/.test(w))
);
